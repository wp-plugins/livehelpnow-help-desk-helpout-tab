...
<script src="//commondatastorage.googleapis.com/lhn/helpout/scripts/lhnhelpouttab-current.min.js" type="text/javascript" id="lhnscriptho"></script>
...
$new_instance['textarea_id'] = "<script type=\"text/javascript\">
	...
	var lhnDepartmentN = ". ($new_instance['livehelpnow_lhnDepartmentN'] == "on" ? "1" : "0") ."; 
